...
namespace views
{
    ...
    bool SilverlightView::OnMousePressed(const ui::MouseEvent& event)
    {
        RequestFocus();
    ...
    bool SilverlightView::OnMouseDragged(const ui::MouseEvent& event)
    {
        MSG msg = event.native_event();
        ax_host_->OnWindowlessMouseMessage(msg.message, msg.wParam, msg.lParam);
        return true;
    ...
    void SilverlightView::OnMouseReleased(const ui::MouseEvent& event)
    {
        MSG msg = event.native_event();
        ax_host_->OnWindowlessMouseMessage(msg.message, msg.wParam, msg.lParam);
    }

    void SilverlightView::OnMouseMoved(const ui::MouseEvent& event)
    {
        MSG msg = event.native_event();
        ax_host_->OnWindowlessMouseMessage(msg.message, msg.wParam, msg.lParam);
    }

    bool SilverlightView::OnKeyPressed(const ui::KeyEvent& event)
    {
        MSG msg = event.native_event();
    ...
    bool SilverlightView::OnKeyReleased(const ui::KeyEvent& event)
    {
        MSG msg = event.native_event();
        ax_host_->OnWindowMessage(msg.message, msg.wParam, msg.lParam);
        return true;
